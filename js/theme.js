...
(function (global) {
  ...
  var BACKDROPS = [
    ...
    { name: 'bars', tier: 'mid', weight: 2.4, drift: 'drift-horiz',
    ...
    { name: 'stripes-tight', tier: 'loud', weight: 1.2, drift: 'drift-diag',
  ...
  function random() {
    ...
    var bd       = backdrop.make(tones(palette));
