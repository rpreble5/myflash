...
(function (global) {
  ...
  var FONTS = [
    ...
    { face: '"Six Caps", sans-serif', track: '-.005em', caps: true, wght: 400, off: true },
    ...
    /* technical */
    { face: '"Michroma", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Orbitron", sans-serif', track: '0', caps: false, wght: 800, off: true },
    { face: '"Audiowide", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Syncopate", sans-serif', track: '0', caps: false, wght: 700, off: true },
    { face: '"Jura", sans-serif', track: '0', caps: false, wght: 700, off: true },
    { face: '"Exo 2", sans-serif', track: '0', caps: false, wght: 800 },
    { face: '"Quantico", sans-serif', track: '0', caps: false, wght: 700, off: true },
    { face: '"Tomorrow", sans-serif', track: '0', caps: false, wght: 700, off: true },
    { face: '"Chakra Petch", sans-serif', track: '0', caps: false, wght: 700, off: true },
    { face: '"Bai Jamjuree", sans-serif', track: '0', caps: false, wght: 700, off: true },
    { face: '"Kanit", sans-serif', track: '0', caps: false, wght: 800 },
    { face: '"Sarpanch", sans-serif', track: '0', caps: false, wght: 800, off: true },
    { face: '"Days One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Aldrich", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Electrolize", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Share Tech", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Turret Road", sans-serif', track: '0', caps: false, wght: 800, off: true },
    { face: '"Unica One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Genos", sans-serif', track: '0', caps: false, wght: 800, off: true },
    { face: '"Reem Kufi", sans-serif', track: '0', caps: false, wght: 700, off: true },
    ...
    { face: '"Iceberg", sans-serif', track: '.01em', caps: true, wght: 400, off: true },
    { face: '"Rationale", sans-serif', track: '.01em', caps: true, wght: 400 },
    { face: '"Voltaire", sans-serif', track: '.01em', caps: true, wght: 400 },

    /* impact */
    { face: '"Black Ops One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Bowlby One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Bowlby One SC", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Racing Sans One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Jockey One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Hammersmith One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Changa", sans-serif', track: '0', caps: false, wght: 800, off: true },
    { face: '"Signika Negative", sans-serif', track: '0', caps: false, wght: 700, off: true },
    { face: '"Wendy One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Poller One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Spicy Rice", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Kumar One", sans-serif', track: '0', caps: false, wght: 400, off: true },
    ...
    { face: '"Skranji", sans-serif', track: '0', caps: false, wght: 700, off: true },

    /* grotesque */
    { face: '"Figtree", sans-serif', track: '-.03em', caps: false, wght: 900, off: true },
    { face: '"Manrope", sans-serif', track: '-.03em', caps: false, wght: 800, off: true },
    { face: '"Epilogue", sans-serif', track: '-.03em', caps: false, wght: 800, off: true },
    { face: '"Urbanist", sans-serif', track: '-.03em', caps: false, wght: 900, off: true },
    { face: '"Red Hat Display", sans-serif', track: '-.03em', caps: false, wght: 900, off: true },
    { face: '"Be Vietnam Pro", sans-serif', track: '-.03em', caps: false, wght: 800, off: true },
    { face: '"Hanken Grotesk", sans-serif', track: '-.03em', caps: false, wght: 800, off: true },
    { face: '"Public Sans", sans-serif', track: '-.03em', caps: false, wght: 900 },
    { face: '"Overpass", sans-serif', track: '-.03em', caps: false, wght: 900, off: true },
    { face: '"Karla", sans-serif', track: '-.03em', caps: false, wght: 800, off: true },
    { face: '"Rubik", sans-serif', track: '-.03em', caps: false, wght: 800 },
    { face: '"Asap", sans-serif', track: '-.03em', caps: false, wght: 700, off: true },
    { face: '"Catamaran", sans-serif', track: '-.03em', caps: false, wght: 900, off: true },
    { face: '"Mulish", sans-serif', track: '-.03em', caps: false, wght: 900, off: true },
    { face: '"Commissioner", sans-serif', track: '-.03em', caps: false, wght: 900 },
    { face: '"Anybody", sans-serif', track: '-.03em', caps: false, wght: 800 },
    { face: '"Familjen Grotesk", sans-serif', track: '-.03em', caps: false, wght: 700, off: true },
    { face: '"Darker Grotesque", sans-serif', track: '-.03em', caps: false, wght: 800, off: true },

    /* quirky */
    { face: '"Modak", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Climate Crisis", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Rubik Vinyl", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Rubik Dirt", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Rubik Distressed", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Rubik Marker Hatch", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Rubik Spray Paint", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Rubik Storm", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Rubik Microbe", sans-serif', track: '0', caps: false, wght: 400, off: true },
    { face: '"Silkscreen", sans-serif', track: '0', caps: false, wght: 700, off: true }
  ];
